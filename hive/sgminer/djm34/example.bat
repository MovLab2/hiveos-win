...
@rem sgminer.exe 
@rem pause
sgminer.exe --no-submit-stale --kernel Lyra2RE -o stratum+tcp://pool.verters.com:4444 -u djm34t.user -p password    --gpu-platform 1   -I 17
@rem sgminer.exe --kernel Lyra2REv2 -o  http://127.0.0.1:7785/  -u Dominique -p MyPass --gpu-platform 1   -I 18  -g 8 -w 32 
