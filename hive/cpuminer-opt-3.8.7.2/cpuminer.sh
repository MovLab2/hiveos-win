...
if [[ $FLAG_SSE2 == 1 && $FLAG_SSE42 == 1 && $FLAG_AVX == 1 && $FLAG_AES == 0 && $FLAG_AVX2 == 0 ]]; then
    CPU_FLAG="avx"
...
./cpuminer-$CPU_FLAG.exe -c cpuminer.conf $@ 2>&1 | tee /var/log/miner/cpuminer-opt/cpuminer-opt.log
